...
export const stats: Stat[] = [
  {
    label: "Our Crew",
    icon: <FaObjectGroup size={20} className="text-secondary" />,
    description:
      "A passionate group of thinkers, creators, and engineers working together to turn bold ideas into reality.",
  },
  {
    label: "Progress",
    icon: <FaSortAmountUp size={20} className="text-secondary" />,
    description:
  ...
  },
  {
    ...
    icon: <FaBrain size={20} className="text-secondary" />,
    description:
  ...
  },
  {
    ...
    icon: <FaPlus size={20} className="text-secondary" />,
    description:
