...
export default function LeadershipPrincipleCard({
  ...
  return (
    <div className="group bg-primary text-dark rounded-lg w-full max-w-md lg:w-[calc(50%-12px)] p-4 sm:p-4 md:p-6 hover:shadow-lg hover:bg-secondary/5 transition-all duration-300 flex items-center justify-center">
